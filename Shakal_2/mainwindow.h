...
private slots:
    ...
    void on_horizontalSlider_level_valueChanged(int value);

    void on_horizontalSlider_level_sliderReleased();
...
private:
    ...
    void processNode(Node *current, TriangleMaker tm, float norm);
